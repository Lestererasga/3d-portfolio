...
export function WebRoom({ scale, position, rotation, ...props }) {
  const { nodes, materials } = useGLTF('/models/web-room.glb')
  return (
    <group {...props} dispose={null} scale={scale} position={position} rotation={rotation}>
      <group scale={0.22}>
        <group
          position={[122.305, 30, -54.246]}
...
useGLTF.preload('/models/web-room.glb')
